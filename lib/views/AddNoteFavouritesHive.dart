...
class AddNoteFavouritesHiveScreen extends StatefulWidget {
  AddNoteFavouritesHiveScreen(
      {super.key,
  ...
  int? index;
  @override
  State<AddNoteFavouritesHiveScreen> createState() =>
      _AddNoteFavouritesHiveScreenState();
}

class _AddNoteFavouritesHiveScreenState
    extends State<AddNoteFavouritesHiveScreen> {
                        ...
                        onUserEarnedReward: (_, reward) {
                          ...
                          if (_titlecontroller.text == "" ||
                            ...
                            Notes newNote = Notes(
                                ...
                                date: date);
                            FavRestaurants? restaurant = box.getAt(widget.index!);
